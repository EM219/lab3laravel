        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a @class(['dropdown-item ','active' => Route::is("posts.index")]) href="{{Route('posts.index')}}" >List</a></li>
              <li><a @class(['dropdown-item ','active' => Route::is("posts.trashed")]) href="{{Route('posts.trashed')}}" >Deleted Posts</a></li>
            </ul>
          </li>
        </ul>
      </div>
